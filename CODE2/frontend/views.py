...
from flask import make_response, redirect, render_template, request, url_for, requests
...
def profile():
    ...
    response = requests.get("/projects/database")
...
@login_required
def palettes():
    response = requests.get("/palettes/database")
...
def login():
    ...
    response = requests.post('/user/login', data = payload)
